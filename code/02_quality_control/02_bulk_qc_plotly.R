...
htmlwidgets::saveWidget(highlight(qc_boxplots_plotly,
                                  on = "plotly_click",
...
#### QC cutoffs  ####
qc_cutoff_tb <- tibble(metric = c("overallMapRate", "totalAssignedGene", "numReads", "rRNA_rate"),
...
pd_new_qc_long |>
  ...
  group_map(~{
    ...
    htmlwidgets::saveWidget(highlight(qc_boxplots_lt_plotly,
                                      on = "plotly_click",
                                      off = "plotly_doubleclick",
                                      selectize = TRUE,
                                      dynamic = TRUE,
