...
## prep dirs ##
data_dir <- here("processed-data", "12_tran_deconvolution", "04_get_est_prop")
...
## what data exists?
list.files(here("processed-data","12_tran_deconvolution"))
# "02_deconvolution_Bisque"          "03_deconvolution_hspe"
#### DWLS ####
# fn_dwls <- list.files(here("processed-data","12_tran_deconvolution", "04_deconvolution_DWLS"), pattern = ".Rdata", full.names = TRUE)
...
#### Bisque ####
fn_bisque <- list.files(here("processed-data","12_tran_deconvolution", "02_deconvolution_Bisque"), pattern = ".Rdata", full.names = TRUE)
...
#### MuSiC ####
# fn_music <- list.files(here("processed-data","12_tran_deconvolution", "02_deconvolution_MuSiC"), pattern = ".Rdata", full.names = TRUE)
...
#### hspe ####
fn_hspe <- list.files(here("processed-data","12_tran_deconvolution", "03_deconvolution_hspe"), pattern = "est_prop", full.names = TRUE) 
...
#### BayesPrism ####
# fn_bayes <- list.files(here("processed-data","12_tran_deconvolution", "06_deconvolution_BayesPrism"), pattern = ".Rdata", full.names = TRUE)
...
## export this data
save(prop_long, prop_long_opc, file = here(data_dir, "Tran_prop_long.Rdata"))
