...
est_prop_hspe <- map_dfr(fn_hspe, ~read.csv(.x) |> mutate(method = "hspe"))
...
## combine OligoOPC
prop_long_donor_subset_summary <- prop_long_donor_subset |>
...
## export this data
save(prop_long_donor_subset, prop_long_donor_subset_summary_opc, prop_long_donor_subset_summary, file = here(data_dir, "prop_long_donor_subset.Rdata"))
