...
markv1 <- c(
    "HA_R5_8325A_Star_Final.csv", "HA_R5_8325M_Star_Final.csv",
    "HA_R5_8667A_Star_Final.csv"
)
markv2 <- c(
    "HA_R1_6432A_Star_Final.csv", "HA_R1_6432M_Star_Final.csv",
...
ggsave(
    plot = ggvp, filename = plot.fname, width = 20, height = 20,
    units = "in", dpi = 400
)
